...
descriptor_customize <- function(AA1BB1O3_sample){
  ...
  # (AA1BB1O3_sample = df_expe_elem_user[1,])
  ...
  ir_A1 = numeric()
  for (n in seq(N)){
    if (AA1BB1O3_sample['A1'][n,] == AA1BB1O3_sample['A'][n,]){
      aw_A1[n] = 0
      ad_A1[n] = 0
      mp_A1[n] = 0
      fie_A1[n] = 0
      eln_A1[n] = 0
      ir_A1[n] = 0
      AA1BB1O3_sample['A1_fraction'] = 0
      AA1BB1O3_sample['A_fraction'] = 1
    } else if ((fraction_A1[n,] == 0) | (is.na(fraction_A1[n,]))){
      aw_A1[n] = 0
      ad_A1[n] = 0
      mp_A1[n] = 0
      fie_A1[n] = 0
  ...
  ir_B1 = numeric()
  for (n in seq(N)){
    if (AA1BB1O3_sample['B1'] == AA1BB1O3_sample['B']){
      aw_B1[n] = 0
      ad_B1[n] = 0
      mp_B1[n] = 0
      fie_B1[n] = 0
